<x-user-layout>
    <!-- Hero Section -->
    <section class="relative h-80 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 flex items-center justify-center">
        <div class="absolute inset-0 bg-black opacity-20"></div>

        <div class="relative z-10 text-center px-6 max-w-4xl">
            <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">
                Contact <span class="bg-gradient-to-r from-white to-indigo-200 bg-clip-text text-transparent">CloudCareHost</span>
            </h1>
   ...
   <div class="container max-w-6xl mx-auto px-6 mb-8">
        <div class="text-center">
            <button id="mailUsBtn" class="inline-flex items-center bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
    ...
    <div id="mailUsModal" class="fixed inset-0 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-2xl shadow-xl max-w-md w-full mx-4 border border-gray-200">
            <div class="p-6">
                ...
                <div class="mb-6">
                    <p class="text-gray-600 mb-4">Click the button below to open your default email client and send us a message:</p>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8">
                    ...
                    <form id="contactForm" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="g-recaptcha" data-sitekey="{{ config('services.recaptcha.site_key') }}" data-callback="onRecaptchaSuccess" data-expired-callback="onRecaptchaExpired" data-error-callback="onRecaptchaError"></div>
                        ...
                        <div class="flex items-start">
                            ...
                            <label for="consent" class="text-gray-600 text-sm">
                                I agree to the <a href="{{ route('privacy.policy') }}" class="text-indigo-600 hover:underline">privacy policy</a>
                                and <a href="{{ route('terms') }}" class="text-indigo-600 hover:underline">terms of service</a>.
                    ...
                    <div id="formError" class="hidden mt-6 p-4 bg-red-50 border border-red-200 rounded-lg">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-red-700 text-sm" id="errorMessage">There was an error sending your message. Please try again.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-8">
                    <div class="bg-white rounded-2xl shadow-lg p-8">
                        ...
                        <p class="text-gray-600 mb-8">
                            Our team is ready to assist you with any inquiries. Reach out to us through any of the following channels.
                        </p>

                        <div class="space-y-6">
                            <!-- Location -->
                            <div class="flex items-start">
                                <div class="w-12 h-12 bg-indigo-100 rounded-xl flex items-center justify-center text-indigo-600 mr-4 flex-shrink-0">
                                    <i class="fas fa-map-marker-alt text-lg"></i>
                                </div>
                                <div>
                                    <h3 class="font-semibold text-gray-800 mb-1">Our Location</h3>
                                    <p class="text-gray-600">cloudcarehost technologies, Plot No H, 16, MIDC Rd, Near Ambad Gaon, Nashik, Maharashtra 422010</p>
                                </div>
                            </div>

                            <!-- Phone -->
                            <div class="flex items-start">
                                <div class="w-12 h-12 bg-purple-100 rounded-xl flex items-center justify-center text-purple-600 mr-4 flex-shrink-0">
                            ...
                            <!-- Email -->
                            <div class="flex items-start">
                                <div class="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center text-blue-600 mr-4 flex-shrink-0">
                            ...
                            <!-- Hours -->
                            <div class="flex items-start">
                                <div class="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center text-green-600 mr-4 flex-shrink-0">
                    ...
                    <div class="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl shadow-lg p-8 text-white">
                        ...
                        <p class="text-indigo-100 mb-6">For immediate assistance, check out our knowledge base or submit a support ticket.</p>

                        <div class="space-y-4">
                            <a href="{{Route('knowledge-base')}}" class="flex items-center justify-between p-3 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
                                <span>Knowledge Base</span>
                                <i class="fas fa-arrow-right"></i>
                            </a>
                            <a href="https://clients.cloudcarehost.com/dologin.php" class="flex items-center justify-between p-3 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
                                <span>Submit Support Ticket</span>
                                <i class="fas fa-arrow-right"></i>
                            </a>
                            <a href="{{Route('articles')}}" class="flex items-center justify-between p-3 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
                                <span>Blog</span>
                                <i class="fas fa-arrow-right"></i>
                            </a>
                        </div>
    ...
    <section class="py-16 bg-white">
        <div class="container max-w-6xl mx-auto px-6">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">Our headquarters in San Francisco, where innovation meets exceptional customer service.</p>
            </div>
    ...
    <section class="py-16 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500">
        <div class="container max-w-4xl mx-auto px-6 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('hosting.index') }}" class="bg-white text-indigo-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                    View Hosting Plans
                </a>
                <a href="{{ route('domain-name') }}" class="bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-indigo-600 transition-colors">
                    Get Your Domain
                </a>
            </div>
        </div>
