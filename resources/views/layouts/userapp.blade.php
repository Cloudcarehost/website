...
<head>
    ...
    <meta name="author" content="@yield('meta_author', 'Cloud Care Host')">
    <meta name="title" content="@yield('meta_title', 'Cloud Care Host')">
    <!-- Favicon -->
...
<body class="font-sans antialiased bg-gray-50">
    ...
    <script type="text/javascript">
        ...
        (function () {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/68cae78c4318b419244f3468/1j5p8s04t';
            s1.charset = 'UTF-8';
